...
public class LogUtils {
  ...
  public static void logInterfaceReq(String text) {
    addParams();
    MDC.put("LogType", LogUtils.LogType.REQUEST.getValue());
    INTERFACE_LOG.info(text);
    removeParams();
    MDC.remove("LogType");
  }

  public static void logInterfaceProtocolReq(String text, LogUtils.Protocol protocol) {
  ...
  public static void logInterfaceResp(String text) {
    addParams();
    MDC.put("LogType", LogUtils.LogType.RESPONSE.getValue());
    INTERFACE_LOG.info(text);
    removeParams();
    MDC.remove("LogType");
  }

  public static void logInterfaceProtocolResp(String text, LogUtils.Protocol protocol) {
    MDC.put("Protocol", protocol.getValue());
  ...
  public static void logRemoteProtocolReq(String msg, LogUtils.Protocol protocol) {
    logRemoteByProtocol(msg, protocol, LogUtils.LogType.REQUEST);
  }

  public static void logRemoteProtocolResp(String msg, LogUtils.Protocol protocol) {
    logRemoteByProtocol(msg, protocol, LogUtils.LogType.RESPONSE);
  }

  private static void logRemoteByProtocol(String msg, LogUtils.Protocol protocol, LogUtils.LogType logType) {
    addParams();
